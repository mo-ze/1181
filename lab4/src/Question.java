...
public class Question {
    ...
    /**
     * contructs the questions with difficulty if its in the range of 0 -10;
     * if not in range set it to 0;
     *
     * @param question
     * @param answer
     * @param difficulty
    ...
    public String display() {
        return this.getQuestion() + " (Difficulty: " + this.getDifficulty() + ") ";
    }
}
